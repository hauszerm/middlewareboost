...
{
    public class PrefixHandler<TData>
    {
        public Int32 HandlePrefix(SocketAsyncEventArgs e, AsyncUserToken<TData> receiveSendToken, Int32 remainingBytesToProcess)
        {
            ...
            if (receiveSendToken.receivedPrefixBytesDoneCount == 0)
            {
                ...
                //TODO do not allocate for each new message
